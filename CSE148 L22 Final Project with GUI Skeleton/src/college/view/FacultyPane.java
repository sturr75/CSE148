...
public class FacultyPane {
	...
	public FacultyPane() {
		...
		ttileField = new TextField();
		ttileField.setPromptText("Title");
		ttileField.setPrefWidth(TEXTFIELD_WIDTH_MEDIUM);
		...
		j += 2;
		studentPane.add(ttileField, i, j, 4, 1);

		studentPane.add(salaryField, 4, j, 4, 1);
...
//		buttonBox.getChildren().addAll(insertBtn, searchBtn, removeBtn, updateBtn);
	...
	public void setFacultyPane(GridPane studentPane) {
